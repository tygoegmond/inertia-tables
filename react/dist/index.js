...
const Table = React__namespace.forwardRef(({ className, ...props }, ref) => (jsxRuntime.jsx("div", { className: "relative w-full overflow-auto", children: jsxRuntime.jsx("table", { ref: ref, className: cn("w-full caption-bottom text-sm", className), ...props }) })));
Table.displayName = "Table";
const TableHeader = React__namespace.forwardRef(({ className, ...props }, ref) => (jsxRuntime.jsx("thead", { ref: ref, className: cn("[&_tr]:border-b", className), ...props })));
...
const TableRow = React__namespace.forwardRef(({ className, ...props }, ref) => (jsxRuntime.jsx("tr", { ref: ref, className: cn("border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted", className), ...props })));
TableRow.displayName = "TableRow";
const TableHead = React__namespace.forwardRef(({ className, ...props }, ref) => (jsxRuntime.jsx("th", { ref: ref, className: cn("h-12 px-4 text-left align-middle font-medium text-muted-foreground [&:has([role=checkbox])]:pr-0", className), ...props })));
TableHead.displayName = "TableHead";
const TableCell = React__namespace.forwardRef(({ className, ...props }, ref) => (jsxRuntime.jsx("td", { ref: ref, className: cn("p-4 align-middle [&:has([role=checkbox])]:pr-0", className), ...props })));
...
const DefaultErrorFallback = ({ error, retry }) => (jsxRuntime.jsx("div", { className: "flex flex-col items-center justify-center p-8 border border-destructive/20 rounded-md bg-destructive/5", children: jsxRuntime.jsxs("div", { className: "text-center space-y-4", children: [jsxRuntime.jsx("div", { className: "text-destructive font-medium", children: "Something went wrong with the table" }), jsxRuntime.jsx("div", { className: "text-sm text-muted-foreground", children: error.message || 'An unexpected error occurred' }), jsxRuntime.jsx("button", { onClick: retry, className: "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2", children: "Try again" })] }) }));
...
const TableBodyComponent = React__namespace.memo(({ rows, columnsCount, isLoading = false, emptyMessage = "No results.", }) => {
    if (isLoading) {
        return (jsxRuntime.jsx(TableBody, { children: jsxRuntime.jsx(TableRow, { children: jsxRuntime.jsx(TableCell, { colSpan: columnsCount, className: "h-24 text-center", role: "status", "aria-live": "polite", children: jsxRuntime.jsxs("div", { className: "flex items-center justify-center gap-2", children: [jsxRuntime.jsx("div", { className: "animate-spin rounded-full h-4 w-4 border-b-2 border-foreground" }), "Loading..."] }) }) }) }));
    }
    if (!rows?.length) {
...
const DataTable = React__namespace.memo(({ result, onSort, className = "", isLoading = false, emptyMessage = "No results." }) => {
    ...
    return (jsxRuntime.jsx(ErrorBoundary, { children: jsxRuntime.jsx("div", { className: `rounded-md border ${className}`, role: "table", "aria-label": "Data table", "aria-rowcount": result.data?.length || 0, children: jsxRuntime.jsxs(Table, { children: [jsxRuntime.jsx(TableHeaderComponent, { headerGroups: table.getHeaderGroups(), result: result, onSort: handleSort }), jsxRuntime.jsx(TableBodyComponent, { rows: table.getRowModel().rows, columnsCount: columns.length, isLoading: isLoading, emptyMessage: emptyMessage })] }) }) }));
});
...
exports.default = InertiaTable;
exports.useInertiaTable = useInertiaTable;
